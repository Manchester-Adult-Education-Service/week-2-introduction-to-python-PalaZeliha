...
#age = 28
#food = "Banana"
#print(f"Hello, {name}! This is my friend ")
#print(f"{name} is {age} and  is  years old.")
#print(f"In 5 years, {name} will be {age + 5} and years old.")
#print(f"{name} really likes {food}.")
#print(f"{food.capitalize()} is {name}'s favourite food!")
...
# secondage = int(input("How old are you? "))
# secondfood = input("What is your favourite food? ")
